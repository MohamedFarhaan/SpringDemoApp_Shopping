...
<title>invoice Between Dates</title>
...
<br>
<h5>NO of Records found = <%= request.getAttribute("records") %></h5>
    <table class="table white-card-box">
        <tr>
            ...
            <c:forEach items="${invoices}" var="iter">
            <tr>
	            <th>${iter.invno}</th>
    ...
    <br/>
    <form action = xlsx1 method = "post">
    	<input type = submit class="btn btn-info" value = "Downlaod Invoice Report"><br>
    </form>
    </center>
    </div>
</body>
